<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo __( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/wfmedia?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'wfmedia' );
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'wfmedia' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'wfmedia' ), esc_html__( 'Redux Framework', 'wfmedia' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'wfmedia' ), esc_html__( 'Redux Framework Changelog', 'wfmedia' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'wfmedia' ), esc_html__( 'Get Support', 'wfmedia' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'wfmedia' ), esc_html__( 'Redux Extensions', 'wfmedia' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'wfmedia' ), esc_html__( 'The people that develop Redux Framework', 'wfmedia' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'wfmedia' ), esc_html__( 'Redux Framework Status', 'wfmedia' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'wfmedia' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'wfmedia' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'wfmedia' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'wfmedia' ); ?>
        ...
        public function parse_readme() {
            ...
            return '<script src="' . 'http://gist-it.appspot.com/https://github.com/reduxframework/wfmedia/blob/master/CHANGELOG.md?slice=2:0&footer=0">// <![CDATA[// ]]></script>';
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                ...
                <a href="http://wordpress.org/plugins/wfmedia/" class="review-us button button-primary"
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'wfmedia' ), esc_html( $contributor->login ) ) )
                );
        ...
        public function get_contributors() {
            ...
            $response = wp_remote_get( 'https://api.github.com/repos/ReduxFramework/wfmedia/contributors', array( 'sslverify' => false ) );
